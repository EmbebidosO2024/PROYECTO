...
//    PORT_SetPinMux(PORTE, 6U, kPORT_MuxAlt6);
	...
	/* Configure UART1 RX (PTC3) and TX (PTC4) */
	PORT_SetPinMux(PORTC, 3U, kPORT_MuxAlt3); // UART1_RX
	PORT_SetPinMux(PORTC, 4U, kPORT_MuxAlt4); // UART1_TX
	PORT_SetPinMux(PORTD, 3U, kPORT_MuxAlt3);


//////////////////////////////////////////////////////////////////
    /* PORTE10 is configured as FTM3_CH5  FMU_CH5 -- FTM3_CH5*/
    PORT_SetPinMux(PORTD, 4U, kPORT_MuxAlt4);


    /* PORTE11 (pin E1) is configured as FTM3_CH1-- FTM3_CH4 */
